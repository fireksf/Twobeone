  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      if (statsRes.ok) {
        ...
        console.warn('Admin stats:', statsRes.status, await statsRes.text());
      }
      ...
      if (activityRes.ok) {
        ...
        console.warn('Admin activity:', activityRes.status, await activityRes.text());
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Overview of your content management system</p>
        </div>
        <Button 
          variant="outline" 
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            {contentNeeded.map((item, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-warning-50 rounded-lg gap-2">
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
          ...
          >
            ...
            <p className="text-sm font-medium text-foreground group-hover:text-primary-700">Add Devotional</p>
          </button>
          <button 
          ...
          >
            ...
            <p className="text-sm font-medium text-foreground group-hover:text-primary-700">Add Question</p>
          </button>
          <button 
          ...
          >
            ...
            <p className="text-sm font-medium text-foreground group-hover:text-primary-700">Create Module</p>
          </button>
          <button 
          ...
          >
            ...
            <p className="text-sm font-medium text-foreground group-hover:text-primary-700">Add Group</p>
          </button>
        </div>
      </Card>
    </div>
