                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <CardTitle className="flex items-center gap-2">
                        <User className={prayer.isPartner ? "w-4 h-4 text-sky-600" : "w-4 h-4 text-primary-600"} />
                        {prayer.title}
                      </CardTitle>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            {answeredPrayers.map((prayer) => (
              <Card key={prayer.id} className="border-success-500/30 bg-success-50/30">
                <CardHeader>
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <CardTitle className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="bg-success-50 text-success-700 border-success-500/50">
                      Answered
                    </Badge>
                  </div>
                </CardHeader>
