                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg mb-4">
                        ...
                        <p className="text-xs text-blue-900 italic">{quiz.scripture}</p>
                      </div>

                      {isCompleted && userResult && (
                        <div className="mb-4 p-3 bg-white rounded-lg border">
                          <p className="text-xs text-gray-600 mb-1">Your Result:</p>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
          ...
          <CardContent className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-purple-900">Deepen Understanding</p>
                <p className="text-sm text-purple-700">Learn how you and your partner express love and handle challenges</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <BookOpen className="w-5 h-5 text-purple-600 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-medium text-purple-900">Biblical Insights</p>
                <p className="text-sm text-purple-700">Each result includes Scripture-based guidance for growth</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <Users className="w-5 h-5 text-purple-600 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-medium text-purple-900">Partner Comparison</p>
                <p className="text-sm text-purple-700">Compare results to find compatibility and areas to work on together</p>
              </div>
            </div>
          </CardContent>
        </Card>
