...
export function MobileLoginScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white dark:from-neutral-950 dark:to-neutral-900">
      {/* Safe area top: 44px */}
      <div className="pt-11">
        ...
        <main className="px-4 py-8 pb-32 max-w-md mx-auto">
          ...
          <div className="text-center mb-10">
            <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-primary-500 to-primary-600 rounded-3xl flex items-center justify-center shadow-lg">
          ...
          <div className="flex gap-2 p-1 bg-neutral-100 dark:bg-neutral-900 rounded-xl mb-8">
            <button
              ...
              className={`
                ...
                ${mode === 'login'
                  ? 'bg-card dark:bg-neutral-800 text-neutral-900 dark:text-white shadow-sm'
