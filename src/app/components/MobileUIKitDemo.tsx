        ...
        <div className="pt-11 pb-8">
          ...
          <div className="px-4 mb-8">
            <div className="max-w-2xl mx-auto">
              ...
              {/* Design System Info */}
              <MobileCard className="mb-6 bg-gradient-to-br from-primary-500 to-primary-600 border-0">
    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      <div className="fixed top-4 left-4 z-50">
        <button
          ...
          className="px-4 h-10 bg-card dark:bg-neutral-900 rounded-full shadow-lg border border-neutral-200 dark:border-neutral-800 text-sm font-medium text-neutral-900 dark:text-white hover:scale-105 transition-transform"
        >
          ← Back to Menu
        </button>
      </div>
