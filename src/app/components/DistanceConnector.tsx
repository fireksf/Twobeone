  ...
  return (
    <>
      ...
      <Card className="relative overflow-hidden border-primary-200">
        {/* Animated Background */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-primary-100 via-primary-100 to-sky-100"
          animate={{
            background: [
        ...
        <CardContent className="pt-6 pb-4 relative z-10">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute top-2 right-2 h-8 w-8 text-muted-foreground hover:text-primary-600"
                ...
                <Avatar className="w-16 h-16 border-4 border-white shadow-lg">
                  {userAvatar ? (
                    <>
                      ...
                      <AvatarFallback className="bg-gradient-to-br from-primary-400 to-primary-500 text-white">
                        {userInitials}
                      </AvatarFallback>
                    </>
                  ) : (
                ...
                <AnimatePresence>
                  {distance !== null && (
                    <motion.div
                      ...
                      className="absolute top-[-20px] left-1/2 -translate-x-1/2 z-20 bg-card px-2 py-0.5 rounded-full shadow-md border border-primary-300"
                    >
                ...
                <Avatar className="w-16 h-16 border-4 border-white shadow-lg">
                  {partnerAvatar ? (
                    <>
                      ...
                      <AvatarFallback className="bg-gradient-to-br from-sky-500 to-sky-500 text-white">
                        {partnerInitials}
                      </AvatarFallback>
                    </>
                  ) : (
            ...
            {!userLocation?.location && (
              ...
              >
                <Button
                  ...
                  variant="outline"
                  onClick={() => setShowSettings(true)}
                  className="bg-card/80 backdrop-blur-sm text-primary-600 border-primary-300 hover:bg-primary-50"
                >
