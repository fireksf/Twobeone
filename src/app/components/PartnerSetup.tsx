      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <Card className="max-w-md w-full">
          <CardContent className="pt-12 pb-12 text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-success-500 to-success-500 flex items-center justify-center mx-auto mb-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-sky-50 border border-sky-200 rounded-lg p-4">
              ...
              <p className="text-xs text-sky-700 mt-2">
                Temporary password: <code className="bg-sky-100 px-2 py-1 rounded">TempPassword123!</code>
              </p>
            </div>
