  ...
  if (!module || module.lessons.length === 0) {
    return (
      <div style={{ padding: 'var(--spacing-6)', textAlign: 'center' }}>
        ...
        >
          <ArrowLeft style={{ width: 18, height: 18 }} /> {t.common.back}
        </button>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)', paddingBottom: 'var(--spacing-10)' }}>
      ...
      <div style={{
        ...
        >
          <ChevronLeft style={{ width: 16, height: 16 }} /> {t.common.previous}
        </button>
        ...
        >
          {t.common.next} <ChevronRight style={{ width: 16, height: 16 }} />
        </button>
      </div>
      ...
      >
        ...
        {isSaving ? t.common.saving : isCompleted ? `${t.devotionals.completed} ✓` : t.devotionals.markComplete}
      </button>
