  ...
  return (
    <ContentLanguageProvider>
      <div className="min-h-screen bg-muted">
        {/* Header */}
        <header className="bg-gradient-to-r from-primary-600 to-sky-600 text-white shadow-lg">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary-100 hidden sm:block">Content Management System</p>
                </div>
              </div>
              <Button 
                variant="secondary" 
