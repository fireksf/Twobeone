          ...
          <ScrollArea className="max-h-[600px]">
            <div className="space-y-6 pr-4">
              {question.prompts.map((prompt, index) => (
                <Card key={prompt.id} className="p-4 bg-muted">
                  <div className="mb-2">
              ...
              return (
                <div key={prompt.id} className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-muted-foreground flex-1">{prompt.text}</p>
                  </div>
                  {hasAnswer ? (
                    <div className="bg-primary-50 rounded-lg p-3 ml-10">
                      <p className="text-foreground">{formatAnswer(answer, prompt.type)}</p>
                    </div>
                  ) : (
                    <div className="bg-muted rounded-lg p-3 ml-10 text-muted-foreground text-sm italic">
                      Not answered yet
                    </div>
                  )}
                </div>
