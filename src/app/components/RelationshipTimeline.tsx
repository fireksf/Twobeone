...
const CATEGORIES = [
  { value: 'First Meeting', icon: '👋', color: 'from-blue-500 to-cyan-500', emoji: '👋' },
  { value: 'First Date', icon: '🌹', color: 'from-pink-500 to-rose-500', emoji: '🌹' },
  { value: 'Commitment', icon: '💑', color: 'from-purple-500 to-pink-500', emoji: '💑' },
  { value: 'Engagement', icon: '💍', color: 'from-yellow-500 to-amber-500', emoji: '💍' },
  { value: 'Wedding', icon: '👰', color: 'from-orange-500 to-red-500', emoji: '👰' },
  { value: 'Anniversary', icon: '🎂', color: 'from-green-500 to-emerald-500', emoji: '🎂' },
  { value: 'Travel', icon: '✈️', color: 'from-cyan-500 to-blue-500', emoji: '✈️' },
  { value: 'Achievement', icon: '🏆', color: 'from-purple-600 to-indigo-600', emoji: '🏆' },
  { value: 'Challenge', icon: '💪', color: 'from-red-500 to-pink-500', emoji: '💪' },
  { value: 'Celebration', icon: '🎉', color: 'from-yellow-400 to-orange-400', emoji: '🎉' },
  { value: 'Spiritual', icon: '✨', color: 'from-indigo-500 to-purple-500', emoji: '✨' },
  { value: 'General', icon: '❤️', color: 'from-pink-400 to-red-400', emoji: '❤️' }
];
        ...
        <div className="px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {stats && (
                  <p className="text-sm text-gray-500">{stats.daysTogether} days together</p>
                )}
              </div>
            </div>
            <Button 
          ...
          {stats && (
            <div className="grid grid-cols-4 gap-2 mb-4">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-pink-700">{stats.daysTogether}</div>
                <div className="text-xs text-pink-600">Days</div>
              </div>
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-blue-700">{stats.avgEmotion}</div>
                <div className="text-xs text-blue-600">Avg Joy</div>
              </div>
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-yellow-700">{stats.achievements}</div>
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={activeView === 'timeline' ? 'bg-gradient-to-r from-purple-600 to-pink-600' : ''}
            >
            ...
            <Button
              ...
              className={activeView === 'graph' ? 'bg-gradient-to-r from-purple-600 to-pink-600' : ''}
            >
            ...
            <Button
              ...
              className={activeView === 'badges' ? 'bg-gradient-to-r from-purple-600 to-pink-600' : ''}
            >
            ...
            {milestones.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                  Document your relationship's special moments and watch your story unfold
                </p>
                <Button 
                  onClick={() => setIsOpen(true)}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
                        ...
                        <CardContent className="p-5">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                {milestone.isPartner && (
                                  <Badge className="bg-gradient-to-r from-pink-100 to-red-100 text-pink-800 text-xs">
                                    💕 {partnerName}
                                  </Badge>
                                )}
                              </div>
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                            <div className="flex items-center gap-4 text-sm text-gray-500">
                              ...
                              <span className="text-xs text-gray-400">{getTimeAgo(milestone.date)}</span>
                            </div>
              ...
              <CardContent>
                {milestones.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">Add milestones to see your emotional journey</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-center gap-4 pt-4 border-t">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-600">Medium (4-5)</span>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div 
                        ...
                        className={`relative overflow-hidden rounded-xl p-4 transition-all ${
                          isEarned 
                            ...
                            : 'bg-gray-50 border-2 border-gray-200 opacity-50 grayscale'
                        }`}
                      >
                        {isEarned && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
              >
                {isLoading ? 'Saving...' : editingMilestone ? 'Update' : 'Add Milestone'}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
