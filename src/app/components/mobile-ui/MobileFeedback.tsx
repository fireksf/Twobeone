...
export function MobileBadge({
  ...
  const variantClasses = {
    ...
    info: 'bg-secondary-50 text-secondary-700 dark:bg-secondary-900/20 dark:text-secondary-400'
  };
...
export function MobileLoader({
  ...
  const colorClasses = {
    primary: 'border-rose-600 border-t-transparent',
  ...
  if (fullScreen) {
    return (
      <div className="fixed inset-0 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-sm flex items-center justify-center z-50">
        {spinner}
      </div>
    );
  }
