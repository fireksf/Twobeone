...
export function MobileAppBar({
  ...
  const variantClasses = {
    default: 'bg-card dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800',
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Active indicator */}
                {isActive && (
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-12 h-1 bg-primary-600 dark:bg-primary-400 rounded-t-full" />
                )}
              </button>
            );
          })}
