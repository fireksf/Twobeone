      ...
      <div className="max-w-3xl mx-auto px-4 mt-14 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge className="bg-primary-600">{getTimeUntil(group.nextMeeting)}</Badge>
                  </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full grid grid-cols-4">
            ...
            <TabsTrigger value="meetings">{t.milestones.milestoneDate}</TabsTrigger>
            <TabsTrigger value="members">{t.community.members}</TabsTrigger>
            <TabsTrigger value="chat">{t.community.sendMessage}</TabsTrigger>
          </TabsList>
                ...
                {group.leaders.map((leader: any, idx: number) => (
                  <div key={idx} className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-primary-600 mb-1">{leader.role}</p>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  {group.resources.map((resource: any, idx: number) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-sky-100 to-sky-100 flex items-center justify-center">
                ...
                {group.recentActivity.map((activity: any, idx: number) => (
                  <div key={idx} className="flex items-center gap-3 text-sm">
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-muted-foreground text-xs ml-2">{activity.time}</span>
                    </div>
                  </div>
                ))}
              </CardContent>
                ...
                {group.upcomingMeetings?.map((meeting: any, idx: number) => (
                  <div key={idx} className="p-4 rounded-lg border bg-gradient-to-r from-primary-50 to-primary-100">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <Badge className="bg-primary-600">{getTimeUntil(meeting.date)}</Badge>
                    </div>
                    <p className="text-sm text-muted-foreground">Speaker: {meeting.speaker}</p>
          ...
          <TabsContent value="chat" className="space-y-4 mt-4">
            {group.isJoined ? (
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-4 border-t">
                    ...
                    />
                    <Button onClick={handleSendMessage} className="bg-primary-600 hover:bg-primary-700">
              ...
              <Card className="p-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Join to Chat</h3>
        ...
        {group.isJoined && (
          <Card className="border-error-500/30">
            <CardContent className="p-4">
              <Button 
                variant="outline" 
                className="w-full text-error-500 hover:text-error-700 hover:bg-error-50 border-error-500/30"
