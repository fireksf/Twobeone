  ...
  return (
    <div className="space-y-6 pb-24">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">Review your conversations and responses</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="p-4 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-2xl font-semibold text-green-600">{answeredCount}</p>
        ...
        <Card className="p-4 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-2xl font-semibold text-rose-600">{bothAnsweredCount}</p>
            <p className="text-xs text-gray-600 mt-1">Together</p>
          </div>
        </Card>
      </div>
                  ...
                  <CardContent className="p-6 space-y-6">
                    ...
                    <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-gray-800 italic mb-2">{question.verse}</p>
                          <p className="text-sm text-gray-600">{question.verseReference}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2">
                        {question.prompts?.map((prompt, index) => (
                          <li key={prompt.id || index} className="flex items-start gap-2 text-gray-700">
                        ...
                        {hasAnswer && (
                          <div className="space-y-3">
                            ...
                            <div className="bg-blue-50 p-4 rounded-lg">
                              <p className="text-gray-700">{question.userResponse}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {hasPartnerAnswer && (
                          <div className="space-y-3">
                            ...
                            <div className="bg-rose-50 p-4 rounded-lg">
                              <p className="text-gray-700">{question.partnerResponse}</p>
                            </div>
                          </div>
                        )}
                      </>
