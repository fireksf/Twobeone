  ...
  return (
    <Card className="bg-card rounded-2xl p-6">
      <div className="flex items-center gap-2 text-primary-600 mb-4">
        ...
        <h3 className="font-medium">{t.dashboard.todaysMood}</h3>
      </div>

      <div className="space-y-4">
        {/* You */}
        <div>
          <p className="text-sm text-muted-foreground mb-2">{t.dashboard.yourMood}</p>
        ...
        {/* Partner */}
        <div>
          <p className="text-sm text-muted-foreground mb-2">{t.dashboard.partnersMood}</p>
          <div className="flex gap-3">
            {moods.map((mood) => (
              <div
                key={mood.value}
