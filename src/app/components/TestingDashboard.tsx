...
export function TestingDashboard({ onBack }: TestingDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-pink-900/20 p-4 md:p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-gray-500">Total Tests</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-green-200 bg-green-50">
              ...
              <CardContent>
                <p className="text-2xl text-green-600">{overallStats.passed}</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-red-200 bg-red-50">
              ...
              <CardContent>
                <p className="text-2xl text-red-600">{overallStats.failed}</p>
              </CardContent>
            </Card>

            <Card className="border-yellow-200 bg-yellow-50">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-gray-500">Running</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-2xl text-yellow-600">{overallStats.running}</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-gray-50">
              ...
              <CardContent>
                <p className="text-2xl text-gray-600">{overallStats.pending}</p>
              </CardContent>
            </Card>
          </div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-2 mb-1">
                            <Icon className="w-4 h-4 text-purple-600 dark:text-purple-400 flex-shrink-0 mt-1" />
                  ...
                  <>
                    <div className="flex items-center justify-between flex-wrap gap-3">
                      <div className="flex items-center gap-3">
                        <activeFlowData.icon className="w-6 h-6 text-purple-600 dark:text-purple-400" />
                        <div>
