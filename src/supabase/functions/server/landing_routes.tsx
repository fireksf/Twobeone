...
const defaultContent = {
  ...
  stats: [
    { label: 'Active Couples', value: '10k+', gradient: 'from-rose-50 to-pink-50' },
    { label: 'Devotionals Read', value: '500k+', gradient: 'from-purple-50 to-indigo-50' },
    { label: 'Prayers Shared', value: '250k+', gradient: 'from-amber-50 to-orange-50' },
    { label: 'Average Rating', value: '4.9★', gradient: 'from-green-50 to-emerald-50' }
  ],
  testimonials: [
    {
      name: 'Sarah & Mike',
