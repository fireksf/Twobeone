          ...
          <Card className="mb-6 overflow-hidden border-blue-200">
            ...
            <CardHeader className="text-center pb-4">
              ...
              <div className="mt-4">
                ...
                <p className="text-sm text-gray-600">Spiritual Maturity Score</p>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <p className="text-center text-gray-600">{stageInfo.description}</p>
              ...
              <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-blue-900 italic mb-1">"{stageInfo.scripture.verse}"</p>
                    <p className="text-xs text-blue-700">— {stageInfo.scripture.reference}</p>
                  </div>
                </div>
              </div>
          ...
          <Card className="mb-6 bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
            ...
            <CardContent className="space-y-3">
              <div className="p-3 bg-white rounded-lg border">
                <p className="text-sm font-medium text-purple-900 mb-1">Pray together daily</p>
                <p className="text-sm text-gray-600">Couples who pray together grow stronger spiritually and relationally</p>
              </div>
              <div className="p-3 bg-white rounded-lg border">
                <p className="text-sm font-medium text-purple-900 mb-1">Study Scripture together</p>
                <p className="text-sm text-gray-600">Read and discuss the Bible with your partner to deepen both your faith</p>
              </div>
              <div className="p-3 bg-white rounded-lg border">
                <p className="text-sm font-medium text-purple-900 mb-1">Serve side by side</p>
                <p className="text-sm text-gray-600">Find ways to serve together in your church or community</p>
              </div>
            </CardContent>
          </Card>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50/50 to-indigo-50/50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <Card className="border-blue-200">
          <CardHeader>
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 mb-4 mx-auto">
            ...
            {question.options.map((option, index) => {
              ...
              return (
                <Button
                  ...
                  className="w-full h-auto py-4 text-left justify-start bg-white hover:bg-blue-50 text-gray-900 border-2 border-gray-200 hover:border-blue-300"
                  variant="outline"
                >
