...
export function CommunityGroupsScreen({ 
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'bible-study': return 'from-blue-500 to-indigo-500';
      case 'prayer-room': return 'from-purple-500 to-violet-500';
  ...
  const getActivityBadge = (level: string) => {
    switch (level) {
      case 'high':
        return <Badge className="bg-green-100 text-green-800 border-green-200"><Flame className="w-3 h-3 mr-1" />Very Active</Badge>;
      case 'medium':
        return <Badge className="bg-blue-100 text-blue-800 border-blue-200"><TrendingUp className="w-3 h-3 mr-1" />Active</Badge>;
      default:
        return <Badge className="bg-gray-100 text-gray-800 border-gray-200"><Clock className="w-3 h-3 mr-1" />Casual</Badge>;
    }
  };
        ...
        <div className="px-4 py-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Connect with Christian couples</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-2">
            <Button
              ...
              className={selectedType === 'all' ? 'bg-gradient-to-r from-purple-600 to-pink-600' : ''}
            >
            ...
            <Button
              ...
              className={selectedType === 'couple' ? 'bg-gradient-to-r from-pink-600 to-rose-600' : ''}
            >
            ...
            <Button
              ...
              className={selectedType === 'bible-study' ? 'bg-gradient-to-r from-blue-600 to-indigo-600' : ''}
            >
            ...
            <Button
              ...
              className={selectedType === 'prayer-room' ? 'bg-gradient-to-r from-purple-600 to-violet-600' : ''}
            >
              <MessageCircle className="w-4 h-4 mr-2" />
              Prayer
            </Button>
        ...
        {pendingGroups.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <Badge className="bg-orange-100 text-orange-800">{pendingGroups.length}</Badge>
            </div>
        ...
        {myGroups.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <Badge className="bg-green-100 text-green-800">{myGroups.length}</Badge>
            </div>
            <div className="space-y-4">
              {myGroups.map(group => (
                <GroupCard key={group.id} group={group} />
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <Badge className="bg-purple-100 text-purple-800">{discoverGroups.length}</Badge>
            </div>
          </div>
