...
export function MobileDashboardScreen() {
  ...
  const stats = [
    { label: 'Day Streak', value: '12', icon: <TrendingUp className="w-5 h-5" />, color: 'text-success-600' },
    { label: 'Devotions', value: '45', icon: <BookOpen className="w-5 h-5" />, color: 'text-secondary-600' },
    { label: 'Prayers', value: '28', icon: <Heart className="w-5 h-5" />, color: 'text-rose-600' }
  ];
  
  const quickActions = [
    { id: 'daily-verse', label: 'Daily Verse', icon: <BookOpen className="w-6 h-6" />, color: 'bg-secondary-500' },
    { id: 'pray', label: 'Pray Together', icon: <Heart className="w-6 h-6" />, color: 'bg-rose-500' },
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="pt-11">
        ...
        <main className="px-4 py-6 pb-32 max-w-6xl mx-auto">
          ...
          <MobileCard 
            className="mb-6 bg-gradient-to-br from-rose-500 to-rose-600 border-0 text-white"
            shadow="lg"
          >
            ...
            <p className="text-rose-100 text-sm mb-4">Together for 2 years, 3 months</p>
            
            <div className="flex items-center gap-2">
              <Award className="w-4 h-4 text-rose-200" />
              <span className="text-sm text-rose-100">12 Day Streak - Keep it up! 🔥</span>
            </div>
          </MobileCard>
          ...
          <section className="mb-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <button className="text-sm text-rose-600 dark:text-rose-400 font-medium">
                View All
              </button>
            </div>
