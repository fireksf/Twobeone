        ...
        <div className="space-y-2">
          {question.prompts.map((prompt, index) => (
            <button
              ...
              className="w-full flex items-start gap-3 p-4 bg-gradient-to-r from-gray-50 to-purple-50 hover:from-purple-100 hover:to-indigo-100 rounded-lg border border-gray-200 hover:border-purple-300 transition-all cursor-pointer text-left group"
            >
              <span className="text-purple-600 font-semibold flex-shrink-0 group-hover:scale-110 transition-transform">
                {index + 1}.
              </span>
              <p className="text-gray-700 group-hover:text-purple-900 flex-1">{prompt}</p>
              <CheckCircle2 className="w-5 h-5 text-gray-300 group-hover:text-purple-600 flex-shrink-0 transition-colors" />
            </button>
          ))}
        </div>
        ...
        <>
          ...
          <div>
            ...
            <div className="bg-rose-50 rounded-lg p-4">
              <p className="text-gray-800 whitespace-pre-line">{question.partnerAnswer}</p>
            </div>
          </div>
        </>
      )}
