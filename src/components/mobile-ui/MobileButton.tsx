...
export function MobileButton({
  ...
  const variantClasses = {
    primary: 'bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white shadow-md disabled:bg-neutral-300 disabled:text-neutral-500',
    ...
    text: 'bg-transparent hover:underline text-rose-600 dark:text-rose-400 disabled:opacity-50',
