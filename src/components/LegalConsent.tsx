      ...
      <div className="space-y-6 py-4">
        ...
        <div className="bg-purple-50 border-l-4 border-purple-600 p-4 rounded">
          <div className="flex gap-3">
            ...
            <div>
              <h4 className="font-semibold text-purple-900 mb-1">{content.importantNote}</h4>
              <p className="text-sm text-purple-800">{content.noteText}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Button
              variant="link"
              size="sm"
              className="h-auto p-0 text-xs text-purple-600 hover:text-purple-700 ml-8"
